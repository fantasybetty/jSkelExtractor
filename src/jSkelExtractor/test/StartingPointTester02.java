...
public class StartingPointTester02 extends JFrame{
	...
	public StartingPointTester02(File serializedMesh) {
		...
		vco.put("showFeaturePoints", false);
		vco.put("showDiameter", true);
		vco.put("showStartingPoint", false);
		...
		if(fileChooser.showSaveDialog(this) == JFileChooser.APPROVE_OPTION){
			...
			dstFile = new File(fileChooser.getSelectedFile().getPath()+"\\AllDiameters.png");
	...
	public static void main(String[] args) {
        ...
        public void run() {
        	if(fileChooser.showOpenDialog(null)==JFileChooser.APPROVE_OPTION){
        		...
        		new StartingPointTester02(fileChooser.getSelectedFile());
