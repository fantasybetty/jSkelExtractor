...
public class FeaturePointExtractionTester01 extends JFrame{
	...
	public FeaturePointExtractionTester01(File serializedMesh) {
	...
	public static void main(String[] args) {
        ...
        public void run() {
        	if(fileChooser.showOpenDialog(null)==JFileChooser.APPROVE_OPTION){
        		...
        		new FeaturePointExtractionTester01(fileChooser.getSelectedFile());
