...
public class BeanEditorPanel extends JPanel implements PropertyChangeListener {
    ...
    public BeanEditorPanel(Object bean) {
	...
	public PropertyTableData(Object bean) {
		...
		ex.printStackTrace();
		JOptionPane
			.showMessageDialog(BeanEditorPanel.this, "Error: "
				+ ex.toString(), "Warning",
