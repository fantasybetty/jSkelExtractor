...
public class GraphPanel extends JPanel implements MouseListener,
	 ...
	 * @param colorizer
	 */
	public GraphPanel(SDSResContainer resContainer, String description) {
	...
	public void paint(Graphics plainG) throws IndexOutOfBoundsException {
		...
		this.graph = resContainer.getGraph();
		this.mesh = resContainer.getMesh();
		...
		if(viewConfigObj.get(ViewConfigObj.SHOW_MESH)){
			colorizer = viewConfigObj.getAlgorithmColorizer();		
			this.drawMesh(g, mesh,colorizer);
		}

		colorizer = viewConfigObj.getGraphColorizer();
		this.drawMesh(g, graph,colorizer);
	...
	protected class Mesh3dWindow extends JPanel {
		...
		protected GraphPanel view3dPanel;
		...
		protected Mesh3dWindow(GraphPanel panel) {
			super();
			...
			layout.setVerticalGroup(layout.createSequentialGroup()
					.addComponent(menuBar, GroupLayout.PREFERRED_SIZE,
							...
							layout.createParallelGroup().addComponent(toolBar)
									.addComponent(view3dPanel).addComponent(
											viewOptionPanel)));
			layout.setHorizontalGroup(layout.createParallelGroup()
					.addComponent(menuBar).addGroup(
							layout.createSequentialGroup()
									.addComponent(toolBar).addComponent(
											view3dPanel).addComponent(
											viewOptionPanel)));
